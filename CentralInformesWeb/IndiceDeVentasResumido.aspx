<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="IndiceDeVentasResumido.aspx.vb" Inherits="CentralInformesWeb.IndiceDeVentasResumido" %>
...
<dx:ASPxImage ID="ASPxImage1" runat="server" 
            ImageUrl="~/Images/document_chart32.png" ShowLoadingImage="true" 
                ...
                <td class="style14">
        <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="Índice de ventas (resumido)" meta:resourcekey="ASPxLabel3"
    ...
    <table style="width:100%;">
            ...
            <TotalSummary>
                <dx:ASPxSummaryItem SummaryType="Sum" FieldName="Facturacion1"></dx:ASPxSummaryItem>
                <dx:ASPxSummaryItem SummaryType="Sum" FieldName="NTickets1"></dx:ASPxSummaryItem>
                <dx:ASPxSummaryItem SummaryType="Sum" FieldName="NLineas1"></dx:ASPxSummaryItem>
                 <dx:ASPxSummaryItem SummaryType="Sum" FieldName="TicketMedio1"></dx:ASPxSummaryItem>
                  <dx:ASPxSummaryItem SummaryType="Sum" FieldName="Upt1"></dx:ASPxSummaryItem>
                   <dx:ASPxSummaryItem SummaryType="Sum" FieldName="Pma1"></dx:ASPxSummaryItem>
            </TotalSummary>
            <Columns>
                <dx:GridViewDataTextColumn Caption="Facturación" Name="Facturacion" VisibleIndex="2" 
                    Width="150px" FieldName="Facturacion" meta:resourcekey="Tienda">
                ...
                <dx:GridViewDataTextColumn Caption="Nº Tickets" Name="NTickets" 
                    VisibleIndex="3" meta:resourcekey="Caja"
                    FieldName="NTickets" Width="150px">
                    <EditCellStyle HorizontalAlign="Center">
                    </EditCellStyle>
                    <HeaderStyle HorizontalAlign="Center" />
                ...
                <dx:GridViewDataTextColumn Caption="Fecha" Name="FechaFactura" VisibleIndex="0" 
                ...
                <dx:GridViewDataTextColumn Caption="Nº Lineas" Name="NLineas" meta:resourcekey="IdConcepto"
                    VisibleIndex="4" FieldName="NLineas" Width="150px">
                    <EditCellStyle HorizontalAlign="Center">
                    </EditCellStyle>
                    <HeaderStyle HorizontalAlign="Center" />
                    <CellStyle HorizontalAlign="Center">
                ...
                <dx:GridViewDataTextColumn Caption="Ticket medio" Name="TicketMedio" 
                    VisibleIndex="5" meta:resourcekey="Ticket"
                    FieldName="TicketMedio" Width="150px">
                    <EditCellStyle HorizontalAlign="Center">
                    </EditCellStyle>
                    <HeaderStyle HorizontalAlign="Center" />
                    <Settings AutoFilterCondition="Contains" />
                ...
                <dx:GridViewDataTextColumn Caption="UPT" meta:resourcekey="Ventas"
                    Name="Upt" VisibleIndex="6" FieldName="Upt" Width="150px">
                    <EditCellStyle HorizontalAlign="Center">
                    </EditCellStyle>
                    <HeaderStyle HorizontalAlign="Center" />
                ...
                <dx:GridViewDataTextColumn Caption="PMA" Name="Pma" VisibleIndex="7" meta:resourcekey="Impuestos"
                    FieldName="Pma" Width="150px">
                    <EditCellStyle HorizontalAlign="Center">
                    </EditCellStyle>
                    <HeaderStyle HorizontalAlign="Center" />
                    <FooterCellStyle ForeColor="Brown" Font-Bold="true"  />
