...
Partial Public Class DiferenciasDeInventario
    ...
    '''<summary>
    '''Control cmbInventario.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents cmbInventario As Global.DevExpress.Web.ASPxComboBox
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents chkAgrupar As Global.DevExpress.Web.ASPxCheckBox

    '''<summary>
    '''Control GridDiferenciasInv.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents GridDiferenciasInv As Global.DevExpress.Web.ASPxGridView
